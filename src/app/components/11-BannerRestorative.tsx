...
import bgBanner from "../../imports/banner_restorative_denstistry.webp";
import bgBannerMobile from "../../imports/banner_restorative_dentistry_sm.webp";
import { QuoteModal } from "./QuoteModal";
import { useInView } from "../../hooks/useInView";

export function BannerRestorative() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="md:relative md:z-10 max-w-6xl mx-auto px-5 md:px-10 lg:px-16">
        <div className="md:flex md:items-center md:w-1/2 md:py-12">
          <div
            className="md:max-w-xl py-12 md:py-16"
            style={{
              opacity: visible ? 1 : 0,
              transform: visible
                ? "translateY(0)"
          ...
          >
            ...
            >
            Root Canal and Crown in Mexico – Restore Damaged Teeth
            </h2>
            <h3
            ...
            >
              A root canal and crown in Mexico can restore comfort, function, and appearance while helping preserve damaged teeth.
            </p>
            <button
