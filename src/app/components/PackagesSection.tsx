...
import patternTile from "../../imports/Patterns_Tile.png";
import package1 from "../../imports/lumineers_full_smile_transformation_cost.png";
import package2 from "../../imports/full_mouth_porcelain_veneers_cost.png";
import package3 from "../../imports/full_mouth_composite_veneers_cost.png";
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-10 lg:px-16">
          ...
          <div className="text-center mb-10 md:mb-14">
            ...
            >
              Every treatment is customized for you. Select the
              option that fits your smile goals and budget.
            </p>
          </div>
