...
import veneersImg from "../../imports/Imagen_Carillas.webp";
import veneersDesktopImg from "../../imports/EDIT_CARISHAS.webp";
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-stretch">
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              What Dental Veneers in Mexico Can Fix
            </h2>
            <h3
            ...
            >
              Porcelain veneers in Mexico fix chips, stains, gaps, and uneven teeth with personalized treatment designed to restore your smile and confidence.
            </p>
          </div>
