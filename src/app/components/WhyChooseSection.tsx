...
import imgTower from "../../imports/A1_tower_collage_2-1.png";
import imgDental from "../../imports/a1web-digital_design.png";
import imgTech from "../../imports/6_montaje_3.2.1-1.png";
    ...
    >
      <div className="max-w-6xl mx-auto px-5 md:px-10 lg:px-16">
        ...
        >
          ...
          >
            We combine top-tier dental expertise with a
            world-class Cancun experience you won't find
            anywhere else.
          </p>
        </div>
